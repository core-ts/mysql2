      ...
      pool.getConnection(function (er0, connection) {
        ...
        connection.beginTransaction(function (er1) {
          if (er1) {
            ...
            connection.execute(query0, function (er2a, results0) {
              if (er2a) {
                connection.rollback(function () {
                  return reject(er2a);
                });
                ...
                if (results0 && results0.affectedRows === 0) {
                  ...
                  connection.execute(queries_1.join(""), function (er2, results) {
                    if (er2) {
                      connection.rollback(function () {
                        return reject(er2);
                      });
      ...
      pool.getConnection(function (er0, connection) {
        ...
        connection.beginTransaction(function (er1) {
          if (er1) {
            ...
            connection.execute(queries_2.join(""), function (er2, results) {
              if (er2) {
                connection.rollback(function () {
                  buildError(er2);
                  return reject(er2);
